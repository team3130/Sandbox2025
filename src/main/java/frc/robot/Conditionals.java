...
public class Conditionals {
    ...
    public static String teacher1Name = "";
    public static String teacher2Name = "";
    public static String teacher3Name = "";
    ...
    public static void main(String[] args) {
        ...
        teacher1Name = s.nextLine();
        System.out.println("Teacher 2: ");
        teacher2Name = s.nextLine();
        System.out.println("Teacher 3: ");
        teacher3Name = s.nextLine();
